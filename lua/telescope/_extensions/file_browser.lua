---@tag file-browser
---@config { ["module"] = "file-browser" }
---@brief [[
--- `file-browser.nvim` is an extension for telescope.nvim. It helps you efficiently
--- create, delete, rename, or move files powered by navigation from telescope.nvim.
---
--- The `file-browser` is setup via the `telescope` extension interface.<br>
--- You can manage the settings for the `file-browser` analogous to how you
...
--- }
--- </code>
--- To get file-browser loaded and working with telescope,
...
--- <pre>
--- To find out more:
--- https://github.com/nvim-jo/file-browser.nvim
---
---   :h |file-browser.picker|
---   :h |file-browser.actions|
---   :h |file-browser.finders|
--- </pre>
---@brief ]]

---@tag file-browser.nvim
