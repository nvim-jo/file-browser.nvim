...
local hijack_netrw = function()
  ...
  -- netrw may or may not be loaded before file-browser config
  ...
  vim.api.nvim_create_autocmd("BufEnter", {
    group = vim.api.nvim_create_augroup("file-browser.nvim", { clear = true }),
    pattern = "*",
    callback = function()
    ...
    desc = "file-browser.nvim replacement for netrw",
  })
end
