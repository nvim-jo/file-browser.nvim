---@tag file-browser.actions
---@config { ["module"] = "file-browser.actions" }
...
--- Creates a new file or dir in the current directory of the |file-browser.picker.file_browser|.
--- - Finder:
...
--- Creates a new file or dir via prompt in the current directory of the |file-browser.picker.file_browser|.
--- - Notes:
---   - You can create folders by ending the name in the path separator of your OS, e.g. "/" on Unix systems
---   - You can implicitly create new folders by passing $/CWD/new_folder/filename.lua
---@param prompt_bufnr number: The prompt bufnr
...
--- Rename files or folders for |file-browser.picker.file_browser|.<br>
--- Notes:
...
--- Move multi-selected files or folders to current directory in |file-browser.picker.file_browser|.<br>
...
--- Copy file or folders recursively to current directory in |file-browser.picker.file_browser|.<br>
--- - Finder:
...
--- Remove file or folders recursively for |file-browser.picker.file_browser|.<br>
--- Note: Performs a blocking synchronized file-system operation.
---@param prompt_bufnr number: The prompt bufnr
...
--- Toggle hidden files or folders for |file-browser.picker.file_browser|.
---@param prompt_bufnr number: The prompt bufnr
...
--- Toggle respect_gitignore for |file-browser.picker.file_browser|.
---@param prompt_bufnr number: The prompt bufnr
...
--- Goto parent directory in |file-browser.picker.file_browser|.
---@param prompt_bufnr number: The prompt bufnr
...
--- Goto working directory of nvim in |file-browser.picker.file_browser|.
---@param prompt_bufnr number: The prompt bufnr
...
--- Change working directory of nvim to the selected file/folder in |file-browser.picker.file_browser|.
---@param prompt_bufnr number: The prompt bufnr
...
--- Goto home directory in |file-browser.picker.file_browser|.
---@param prompt_bufnr number: The prompt bufnr
...
--- Toggle between file and folder browser for |file-browser.picker.file_browser|.
---@param prompt_bufnr number: The prompt bufnr
